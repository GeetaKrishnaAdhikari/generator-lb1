...
var Workspace = require('loopback-workspace-geet').models.Workspace;
var ModelProperty = require('loopback-workspace-geet').models.ModelProperty;
...
exports.getCommandName = function() {
  ...
  else if(process.env.SLC_COMMAND === 'lb1'){
	  command='lb1';
  }
